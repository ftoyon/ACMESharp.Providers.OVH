...
@{
	...
	ModuleVersion = '0.9.1'
	GUID = 'B1C1A704-1464-4390-A720-B3E7ABF94715'
	
	Author = 'https://github.com/ftoyon'

	CompanyName = 'https://github.com/ftoyon/ACMESharp.Providers.OVH'

	Copyright = 'Copyright © Frédéric Toyon / Eugene Bekker. All rights reserved.'	

	Description = "OVH Provider extension library for ACMESharp Client."
	...
	PrivateData = @{
		...
		PSData = @{
			...
			Tags = @('pki','ssl','tls','security','certificates','letsencrypt','acme','powershell','acmesharp','OVH','acmesharp_ext')

			# A URL to the license for this module.
			LicenseUri = 'https://raw.githubusercontent.com/ftoyon/ACMESharp.Providers.OVH/master/LICENSE'

			# A URL to the main website for this project.
			ProjectUri = 'https://github.com/ftoyon/ACMESharp.Providers.OVH'

			# A URL to an icon representing this module.
			IconUri = 'https://cdn.rawgit.com/ebekker/ACMESharp/master/artwork/ACMESharp-logo-square64.png'

			# ReleaseNotes of this module
			ReleaseNotes = 'Please see the release notes from the release distribution page: https://github.com/ftoyon/ACMESharp.Providers.OVH/releases'
